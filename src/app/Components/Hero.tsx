...
const Hero: React.FC = () => {
  ...
  return (
    <section className={`relative pt-28 pb-16 px-4 sm:px-6 lg:px-8 transition-colors duration-300 ${
      ...
      <div ref={dotsRef} className="absolute top-0 left-0 w-full h-full opacity-10 pointer-events-none z-0">
        <div className="absolute top-10 left-10 w-64 h-64"
             style={{ backgroundImage: 'radial-gradient(circle, #4299e1 1.5px, transparent 1.5px)', backgroundSize: '20px 20px' }}>
        </div>
        <div className="absolute bottom-20 right-20 w-72 h-72"
             style={{ backgroundImage: 'radial-gradient(circle, #805ad5 1.5px, transparent 1.5px)', backgroundSize: '18px 18px' }}>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            <p className={`font-bold inline-block mb-4 px-4 py-1 rounded-full border ${
              isDarkMode 
                ? 'bg-gradient-to-r from-purple-600/20 to-pink-500/20 text-purple-300 border-purple-500/30'
            ...
            <h1 className="text-4xl sm:text-5xl font-bold leading-tight mb-6">
              <span className={`${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
                Shaping the Next Generation of HR <span></span>
              </span>
            ...
            <p className={`text-lg max-w-lg mx-auto lg:mx-0 leading-relaxed font-light ${
            ...
            <Button 
              className="w-48 bg-gradient-to-r from-blue-600 to-indigo-700 hover:from-blue-700 hover:to-indigo-800 text-white font-medium shadow-lg shadow-blue-300/30 dark:shadow-blue-900/30 transition-all duration-300 px-8 py-3 mt-6"
            >
              Start Trial Now
            </Button>
          </div>
          ...
          <div className="w-full lg:w-1/2 relative">
            ...
            <div className="absolute -bottom-6 -right-6 w-24 h-24 opacity-30 z-0" 
                style={{ backgroundImage: 'radial-gradient(circle, #4299e1 1px, transparent 1px)', backgroundSize: '8px 8px' }}>
            </div>
